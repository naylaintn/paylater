...
class TemplatePickUp extends StatefulWidget {
  const TemplatePickUp({Key? key}) : super(key: key);

  @override
  _TemplatePickUpState createState() => _TemplatePickUpState();
}

class _TemplatePickUpState extends State<TemplatePickUp> {
  @override
              ...
              Column(
                ...
                children: <Widget> [
                  ...
                  Row(
                    ...
                    children: [
                      Text("Pick up store:", style: TextStyle(fontStyle: FontStyle.italic)),
                      SizedBox(width: 5),
                      Text("Plaza Indonesia", style: TextStyle(fontStyle: FontStyle.italic)),
                    ],
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
